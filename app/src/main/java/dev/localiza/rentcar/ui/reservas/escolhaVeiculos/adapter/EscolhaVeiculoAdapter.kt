package dev.localiza.rentcar.ui.reservas.escolhaVeiculos.adapter
...
import kotlinx.android.synthetic.main.item_escolha_veiculo.view.*


internal class EscolhaVeiculoAdapter : ListAdapter<Veiculo, EscolhaVeiculoAdapter.ViewHolder>(DIFF_CALLBACK) {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.item_escolha_veiculo, parent, false)
